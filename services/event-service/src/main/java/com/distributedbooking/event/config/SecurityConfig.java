...
import com.distributedbooking.event.api.ErrorResponse;
import com.distributedbooking.event.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    @Bean
    SecurityFilterChain eventSecurityFilterChain(
            HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/events/*/publish").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/events/*/unpublish").hasRole("ADMIN")
